...
export default function Gallery() {
  ...
  return (
    <LightGallery plugins={[lgZoom]} mode="lg-fade">
      <div
        id="lightgallery"
        className="flex w-full max-w-[1600px] flex-wrap justify-center gap-6"
      >
        <a
          data-lg-size="1406-1390"
          className="gallery-item hover:border-zinc-700 flex h-52 w-52 cursor-zoom-in rounded-lg border border-solid p-7 transition duration-300 max-sm:h-60 max-sm:w-60 md:h-56 md:w-56 dark:border-dark-500/50 dark:bg-dark-700/60"
        ...
        <a
          ...
          className="gallery-item hover:border-zinc-700 flex h-52 w-52 cursor-zoom-in rounded-lg border border-solid p-7 transition duration-300 sm:h-60 sm:w-60 md:h-56 md:w-56 dark:border-dark-500/50 dark:bg-dark-700/60"
