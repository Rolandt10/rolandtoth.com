    ...
    <LightGallery plugins={[lgZoom]} mode="lg-fade">
      ...
      >
        <a
          ...
          className="gallery-item flex h-52 w-52 cursor-zoom-in rounded-lg border border-solid p-7 transition duration-200 max-sm:aspect-square max-sm:h-auto max-sm:min-w-[calc(50%-1rem)] max-sm:max-w-[calc(50%-1rem)] max-sm:flex-1 max-sm:p-4 dark:border-dark-500/50 dark:bg-dark-700/60 dark:hover:border-dark-400/30"
